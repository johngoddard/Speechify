...
Track.create(title: 'We go to the Moon', artist: 'John F. Kennedy', category: 'history', user_id: 3, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1473109710/images/gvjo2efmut0flsyvavkg.png', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473109702/lrm94k7dcq06cjf3hk3e.mp3')
Track.create(title: 'Miracle on Ice Speech', artist: 'Herb Brooks', category: 'sports', user_id: 3, track_image_url: "http://res.cloudinary.com/dwf6beu4e/image/upload/v1472757301/images/k1pdcy3zlrsbyvmfccsx.png", audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473126993/xku9cjgzv3muutlbsd7l.mp3')
Track.create(title: 'Prom Speech', artist: 'Cady Heron', category: 'entertainment', user_id: 4, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1472757395/images/lktb4nisv5ck9cbokkn3.png', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473126523/sekp7r3ab7yx0hwtafxe.mp3')
Track.create(title: 'RNC Highlights', artist: 'Donald Trump', category: 'politics', user_id: 1, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1472779972/images/fiwheba3gfdo6sjio9ox.png', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473127665/uv32fm5tn6vsgsf364uv.mp3')
Track.create(title: 'DNC Highlights', artist: 'Hillary Clinton', category: 'politics', user_id: 1, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1473127159/images/qbs4dqox12ycaxel3imq.png', audio_url: "http://res.cloudinary.com/dwf6beu4e/video/upload/v1473127417/ep3dcw4xlmreubmorfqe.mp3")
Track.create(title: 'Any Given Sunday', artist: 'Al Pacino', category: 'sports', user_id: 2, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1472779871/images/mn8gcpwg75l97p2oje0b.png', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473126400/wi8dtbavpe7f11yccu5t.mp3')
Track.create(title: 'Gettysburg Address (performed by Jeff Daniels)', category: 'history', artist: 'Abraham Lincoln', user_id: 1, audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473119865/qm8kqaykp8vite0zhswo.mp3', track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1473133351/images/okznnid1yimz45dcowfy.png')
