...
Track.create(title: 'Gettysburg Address (performed by Jeff Daniels)', artist: 'Abraham Lincoln', user_id: 1, track_image_url: 'http://res.cloudinary.com/dwf6beu4e/image/upload/v1472757249/images/gdkh9mcdllcuit3mwbja.png', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1472756934/mzhayn9tvcxy7pqee36i.mp3', audio_url: 'http://res.cloudinary.com/dwf6beu4e/video/upload/v1473119865/qm8kqaykp8vite0zhswo.mp3')
...
PlaylistTrack.create(playlist_id: 1, track_id: 7)
PlaylistTrack.create(playlist_id: 1, track_id: 4)
PlaylistTrack.create(playlist_id: 1, track_id: 6)
PlaylistTrack.create(playlist_id: 1, track_id: 1)

PlaylistTrack.create(playlist_id: 2, track_id: 2)
